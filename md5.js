md5 = {
 ...
 md5_rounds: function(a, b, c, d, k, simple) {
  if(simple) {
   a = md5.cmn(-1732584194, 1732584193, -271733879, k[0], 7, 25, -680876936);
   d = md5.cmn((a & -271733879) | (~a & -1732584194), 271733878, a, k[1], 12, 20, -389564586);
   c = md5.cmn((d & a) | (~d & -271733879), -1732584194, d, k[2], 17, 15, 606105819);
   b = md5.cmn((c & d) | (~c & a), -271733879, c, k[3], 22, 10, -1044525330);
  }else{
   a = md5.cmn((b & c) | (~b & d), a, b, k[0], 7, 25, -680876936);
   d = md5.cmn((a & b) | (~a & c), d, a, k[1], 12, 20, -389564586);
   c = md5.cmn((d & a) | (~d & b), c, d, k[2], 17, 15, 606105819);
   b = md5.cmn((c & d) | (~c & a), b, c, k[3], 22, 10, -1044525330);
  }

  a = md5.cmn((b & c) | (~b & d), a, b, k[4], 7, 25, -176418897);
  d = md5.cmn((a & b) | (~a & c), d, a, k[5], 12, 20, 1200080426);
  c = md5.cmn((d & a) | (~d & b), c, d, k[6], 17, 15, -1473231341);
  b = md5.cmn((c & d) | (~c & a), b, c, k[7], 22, 10, -45705983);
  a = md5.cmn((b & c) | (~b & d), a, b, k[8], 7, 25, 1770035416);
  d = md5.cmn((a & b) | (~a & c), d, a, k[9], 12, 20, -1958414417);
  c = md5.cmn((d & a) | (~d & b), c, d, k[10], 17, 15, -42063);
  b = md5.cmn((c & d) | (~c & a), b, c, k[11], 22, 10, -1990404162);
  a = md5.cmn((b & c) | (~b & d), a, b, k[12], 7, 25, 1804603682);
  d = md5.cmn((a & b) | (~a & c), d, a, k[13], 12, 20, -40341101);
  c = md5.cmn((d & a) | (~d & b), c, d, k[14], 17, 15, -1502002290);
  b = md5.cmn((c & d) | (~c & a), b, c, k[15], 22, 10, 1236535329);

  a = md5.cmn((b & d) | (c & ~d), a, b, k[1], 5, 27, -165796510);
  d = md5.cmn((a & c) | (b & ~c), d, a, k[6], 9, 23, -1069501632);
  c = md5.cmn((d & b) | (a & ~b), c, d, k[11], 14, 18, 643717713);
  b = md5.cmn((c & a) | (d & ~a), b, c, k[0], 20, 12, -373897302);
  a = md5.cmn((b & d) | (c & ~d), a, b, k[5], 5, 27, -701558691);
  d = md5.cmn((a & c) | (b & ~c), d, a, k[10], 9, 23, 38016083);
  c = md5.cmn((d & b) | (a & ~b), c, d, k[15], 14, 18, -660478335);
  b = md5.cmn((c & a) | (d & ~a), b, c, k[4], 20, 12, -405537848);
  a = md5.cmn((b & d) | (c & ~d), a, b, k[9], 5, 27, 568446438);
  d = md5.cmn((a & c) | (b & ~c), d, a, k[14], 9, 23, -1019803690);
  c = md5.cmn((d & b) | (a & ~b), c, d, k[3], 14, 18, -187363961);
  b = md5.cmn((c & a) | (d & ~a), b, c, k[8], 20, 12, 1163531501);
  a = md5.cmn((b & d) | (c & ~d), a, b, k[13], 5, 27, -1444681467);
  d = md5.cmn((a & c) | (b & ~c), d, a, k[2], 9, 23, -51403784);
  c = md5.cmn((d & b) | (a & ~b), c, d, k[7], 14, 18, 1735328473);
  b = md5.cmn((c & a) | (d & ~a), b, c, k[12], 20, 12, -1926607734);
